    ...
    return (
      <div className="mx-auto max-w-lg p-8 font-sans text-sm leading-relaxed text-foreground">
        ...
        <p className="mb-4 text-muted-foreground">
          ...
          <code className="rounded bg-muted px-1 py-0.5">MonadClaim/.env</code> or{" "}
          <code className="rounded bg-muted px-1 py-0.5">MonadClaim/frontend/.env</code>, then restart{" "}
