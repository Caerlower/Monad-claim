        ...
        <div className="flex items-center gap-3">
          <div className="relative w-9 h-9 rounded-2xl overflow-hidden border border-glass-border/70 shadow-[0_10px_30px_rgba(0,0,0,0.25)]">
            ...
            <div className="relative w-full h-full flex items-center justify-center">
              <img src="/download.svg" alt="MonadClaim" className="w-5 h-5 opacity-95" />
            </div>
          </div>
          <span className="font-semibold text-base md:text-lg text-foreground hidden sm:inline">MonadClaim</span>
        </div>
